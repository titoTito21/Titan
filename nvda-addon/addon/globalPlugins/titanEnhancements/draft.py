...
def with_ai(obj, tries=2):
    """Have Titan's AI write the module. ``(module, sentence)``.

    The answer is CHECKED before it is offered, and a module that names a
    rule nothing reads is refused rather than corrected quietly: a wrong
    module loads, matches, and does nothing, which for somebody who cannot
    see the screen is indistinguishable from a reader that has stopped.
    """
