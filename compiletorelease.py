...
def compile_to_release():
    ...
    hidden_imports = [
        ...
        # Titan IM: web-as-backend engine + the two accessible clients
        "src.network.im_web",
        "src.network.im_web.base",
        "src.network.im_web.bridge",
        "src.network.im_web.js_bridge",
        "src.network.im_web.js_whatsapp",
        "src.network.im_web.js_messenger",
        "src.network.im_web.whatsapp_backend",
        "src.network.im_web.messenger_backend",
        "src.network.im_ui_common",
        "src.network.im_client_base",
        "src.network.im_conversation",
        "src.network.im_call_ui",
        "src.network.whatsapp_titan_gui",
        "src.network.messenger_titan_gui",
        ...
        "src.ai.ocr.capture",
        "src.ai.ocr.model",
        "src.ai.ocr.recognizer",
        "src.ai.ocr.uia_snapshot",
        "src.ai.ocr.actions",
        "src.ai.ocr.form_view",
        "src.ai.ocr.mimic",
        "src.ai.ocr.hotkeys",
        "src.controller",
