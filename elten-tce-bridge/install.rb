...
SOURCES = %w[__app.rb titan_bus.rb titan_ui.rb titan_api.rb titan_prefs.rb titan_sounds.rb titan_speech_output.rb
             titan_actions.rb titan_settings.rb titan_net.rb titan_im.rb
             titan_system.rb titan_tools_ui.rb titan_widgets.rb titan_watch.rb elten_main.rb elten_news.rb elten_screen.rb elten_keys.rb elten_api.rb elten_eapi.rb elten_link.rb titan_consent.rb titan_components.rb titan_macros.rb titan_cling.rb titan_apps.rb titan_ai.rb
             titan_shell.rb
             titan_areas.rb titan_console.rb eapi_titan.rb titan_script_ui.rb elten_widget.rb].freeze
